...
boxM4.textContent = default_option[3]
boxH1.textContent = default_option[0]
boxH2.textContent = default_option[1]
boxH3.textContent = default_option[2]
boxH4.textContent = default_option[3]
boxH5.textContent = default_option[4]
...
function winner() {
  if (boxE1.textContent == boxE2.textContent && boxE1.textContent == boxE3.textContent) {
