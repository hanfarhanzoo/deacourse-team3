...
boxM3.textContent = default_option[2];
boxM3.textContent = default_option[0];

boxH1.textContent = default_option[0];
boxH2.textContent = default_option[1];
boxH3.textContent = default_option[2];
boxH4.textContent = default_option[0];
boxH5.textContent = default_option[1];
...
function winner() {
  if (
    boxE1.textContent == boxE2.textContent &&
    boxE1.textContent == boxE3.textContent
  ) {
...
function start() {
  ...
  const rolling = setInterval(function () {
    const result = dice();
    boxE1.textContent = result[0];
    boxE2.textContent = result[1];
    boxE3.textContent = result[2];

    boxM1.textContent = default_option[0];
    boxM2.textContent = default_option[1];
    boxM3.textContent = default_option[2];
    boxM4.textContent = default_option[0];
